...
|             |               |
|-------------|---------------|
| Source      | Modrinth `zV5r3pPn` |
| Open Source | [Yes](https://github.com/tr7zw/3d-skin-layers)            |
...
_256-tall nether with 3D biomes, mountains and more!_
...
_Food/hunger-related HUD improvements_

|             |               |
|-------------|---------------|
| Source      | Modrinth `EsAfCjCV` |
| Open Source | [Yes](https://github.com/squeek502/AppleSkin)            |
| Author      | [squeek502](https://modrinth.com/user/qB1TNdUc)            |
...
|             |               |
|-------------|---------------|
| Source      | Modrinth `ftdbN0KK` |
| Open Source | [Yes](https://github.com/badasintended/badpackets)            |
...
|             |                 |
|-------------|-----------------|
| Source      | CurseForge `317121` |
| Open Source | [Yes](https://github.com/shedaniel/Cloth)              |
...
_Configuration Library for Minecraft Mods_

|             |               |
|-------------|---------------|
| Source      | Modrinth `9s6osm5g` |
| Open Source | [Yes](https://github.com/shedaniel/ClothConfig/)            |
| Author      | [shedaniel](https://modrinth.com/user/1Hsaf75m)            |
| Categories  | library            |

**[Connectible Chains [Fabric]](https://modrinth.com/mod/ykSfIgTw)**  
_Connect your fences with a decorative chain!_

|             |               |
|-------------|---------------|
| Source      | Modrinth `ykSfIgTw` |
| Open Source | [Yes](https://github.com/legoatoom/ConnectibleChains)            |
| Author      | [qendolin](https://modrinth.com/user/jRhn2xbX), [legoatoom](https://modrinth.com/user/C9JhURQF)            |
| Categories  | decoration            |
...
| Open Source | [Yes](https://github.com/CreativeMD/CreativeCore)            |
| Author      | [creativemd](https://modrinth.com/user/YTAyzo4h)            |
| Categories  | library            |
...
**[EnhancedVisuals](https://modrinth.com/mod/KjL0jE2w)**  
_Feel the pain!_

|             |               |
|-------------|---------------|
| Source      | Modrinth `KjL0jE2w` |
| Open Source | [Yes](https://github.com/CreativeMD/EnhancedVisuals)            |
| Author      | [creativemd](https://modrinth.com/user/YTAyzo4h)            |
| Categories  | adventure, decoration            |
...
| Open Source | [Yes](https://github.com/tr7zw/EntityCulling)            |
| Author      | [tr7zw](https://modrinth.com/user/Qnt13hO8)            |
...
| Author      | [modmuss50](https://modrinth.com/user/JZA4dW8o), [sfPlayer1](https://modrinth.com/user/iFMgB5Ib)            |
| Categories  | library            |
...
| Open Source | [Yes](https://github.com/malte0811/FerriteCore)            |
...
_New Nether biomes and structures with the vanilla blocks! (1.18+)_

|             |               |
|-------------|---------------|
| Source      | Modrinth `ZVzW5oNS` |
| Open Source | No            |
| Author      | [Stardust](https://modrinth.com/user/oRXQvVNJ)            |
...
|             |               |
|-------------|---------------|
| Source      | Modrinth `Orvt0mRa` |
| Open Source | [Yes](https://github.com/comp500/Indium)            |
| Author      | [comp500](https://modrinth.com/user/M6f6rkfI)            |
| Categories  | utility            |

**[Inspecio](https://modrinth.com/mod/a93H3mKU)**  
_A Minecraft mod which adds more tooltips._
...
_Forge/Fabric mod that adds the ability to walk around while in inventories_
...
_A mod to optimize the Minecraft networking stack_
...
|             |               |
|-------------|---------------|
| Source      | Modrinth `yBW8D80W` |
| Open Source | [Yes](https://github.com/LambdAurora/LambDynamicLights)            |
| Author      | [LambdAurora](https://modrinth.com/user/rRnTb0fG)            |
| Categories  | adventure, decoration, utility            |

**[LazyDFU](https://modrinth.com/mod/hvFnDODi)**  
_Makes the game boot faster by deferring non-essential initialization_

|             |               |
|-------------|---------------|
| Source      | Modrinth `hvFnDODi` |
| Open Source | [Yes](https://github.com/astei/lazydfu)            |
| Author      | [astei](https://modrinth.com/user/y0WF9UR5)            |
| Categories  | optimization            |
...
_Adds a mod menu to view the list of mods you have installed._
...
_dynamic data pack and registration, villager activities, custom map marker and a lot more_
...
_Vanilla End overhaul for Fabric and Forge, with abstract & alien terrain._
...
_Adds a highly-configurable zoom key for Quilt. The zoom is yours!_

|             |               |
|-------------|---------------|
| Source      | Modrinth `aXf2OSFU` |
| Open Source | [Yes](https://github.com/EnnuiL/OkZoomer)            |
...
| Author      | [OroArmor](https://modrinth.com/user/h74rYEcI), [Ennui](https://modrinth.com/user/K0geyKfU), [LambdAurora](https://modrinth.com/user/rRnTb0fG), [quilt-holdings](https://modrinth.com/user/kLoubsXo)            |
| Categories  | library            |
...
_Moves items smoothly in inventories_

|             |               |
|-------------|---------------|
| Source      | Modrinth `ydZic5r4` |
| Open Source | [Yes](https://github.com/Schauweg/Smooth-Swapping)            |
| Author      | [Schauweg](https://modrinth.com/user/AGzRGj6e)            |
| Categories  | decoration            |
...
_Features that shouldn't be in Sodium._
...
| Open Source | [Yes](https://github.com/Stardust-Labs-MC/Terralith)            |
| Author      | [Stardust](https://modrinth.com/user/oRXQvVNJ)            |
| Categories  | worldgen            |
...
|             |               |
|-------------|---------------|
| Source      | Modrinth `6AQIaxuO` |
| Open Source | [Yes](https://github.com/badasintended/wthit)            |
| Author      | [deirn](https://modrinth.com/user/6MnkHI68)            |
| Categories  | cursed, library, utility            |

**[Xaero's Minimap](https://www.curseforge.com/minecraft/mc-mods/xaeros-minimap)**  
_Displays the nearby world terrain, players, mobs, entities in the corner of your screen. Lets you create waypoints which help you find the locations you've marked._
...
| Open Source | [Yes](https://github.com/YUNG-GANG/YUNGs-API)            |
| Author      | [YUNGNICKYOUNG](https://modrinth.com/user/HCGwycZf)            |
| Categories  | library            |

**[YUNG's Better Desert Temples](https://modrinth.com/mod/XNlO7sBv)**  
_A complete redesign of Minecraft's desert temples!_
...
| Open Source | [Yes](https://github.com/YUNG-GANG/YUNGs-Better-Dungeons)            |
| Author      | [YUNGNICKYOUNG](https://modrinth.com/user/HCGwycZf)            |
| Categories  | adventure, decoration, worldgen            |
...
| Open Source | [Yes](https://github.com/YUNG-GANG/YUNGs-Better-Mineshafts)            |
| Author      | [YUNGNICKYOUNG](https://modrinth.com/user/HCGwycZf)            |
| Categories  | adventure, decoration, worldgen            |
...
_A complete redesign of Minecraft's strongholds!_

|             |               |
|-------------|---------------|
| Source      | Modrinth `kidLKymU` |
| Open Source | [Yes](https://github.com/YUNG-GANG/YUNGs-Better-Strongholds)            |
| Author      | [YUNGNICKYOUNG](https://modrinth.com/user/HCGwycZf)            |
| Categories  | adventure, decoration, worldgen            |
...
_Adds beautiful naturally generated bridges throughout the world!_

|             |               |
|-------------|---------------|
| Source      | Modrinth `Ht4BfYp6` |
| Open Source | [Yes](https://github.com/YUNG-GANG/YUNGs-Bridges)            |
| Author      | [YUNGNICKYOUNG](https://modrinth.com/user/HCGwycZf)            |
| Categories  | adventure, decoration, worldgen            |

**[YUNG's Extras](https://modrinth.com/mod/ZYgyPyfq)**  
_Extra structures, features, and vanilla+ content suitable for any modpack!_

|             |               |
|-------------|---------------|
| Source      | Modrinth `ZYgyPyfq` |
| Open Source | [Yes](https://github.com/YUNG-GANG/YUNGs-Extras)            |
| Author      | [YUNGNICKYOUNG](https://modrinth.com/user/HCGwycZf)            |
| Categories  | adventure, decoration, worldgen            |
